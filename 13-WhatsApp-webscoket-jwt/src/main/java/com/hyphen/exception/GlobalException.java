...
public class GlobalException {
	...
	@ExceptionHandler(NoHandlerFoundExceptionException.class)
	public ResponseEntity<ErrorDetail> handleNoHandlerFoundException(NoHandlerFoundExceptionException e,
			WebRequest req) {
