...
public class User {
	...
	@Embedded
	private Varification verfication;
	...
	public User(Long id, String fullName, String location, String website, String birthDate, String email,
			...
			boolean login_with_google, List<Twit> twit, List<Like> likes, Varification verfication,
	...
	public Varification getVerfication() {
		return verfication;
	}

	public void setVerfication(Varification verfication) {
		this.verfication = verfication;
	}
